...
<body class="tw-bg-coffee-50 tw-font-sans tw-text-coffee-900">
   ...
   <div class="heading">
      <h3><?= $category !== '' ? $category : 'categoria'; ?></h3>
      <p><a href="<?= defined('PUBLIC_BASE') ? PUBLIC_BASE . 'home' : 'home.php'; ?>">inicio</a> <span> / categoria</span></p>
   </div>

   <section class="products tw-mx-auto tw-max-w-[1280px] tw-px-6 tw-py-14">
      <h1 class="title tw-font-sans tw-text-5xl tw-normal-case tw-text-coffee-900">productos por categoria</h1>
      ...
      <div class="box-container tw-grid tw-grid-cols-1 tw-gap-8 sm:tw-grid-cols-2 lg:tw-grid-cols-4">
         <?php if (!empty($products)) { ?>
            ...
            <?php } ?>
         <?php } else { ?>
            <p class="empty">aun no se han anadido productos en esta categoria</p>
         <?php } ?>
      </div>
   </section>
