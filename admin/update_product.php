   ...
   <section class="update-product">
      ...
      ?>
            <form action="" method="POST" enctype="multipart/form-data">
               ...
               <input type="number" min="0" max="9999999999" required placeholder="ingresa el precio del producto" name="price" onkeypress="if(this.value.length == 10) return false;" class="box" value="<?= $fetch_products['price']; ?>">
               <span>actualizar categoría</span>
               <select name="category" class="box" required>
                  <option selected value="<?= $fetch_products['category']; ?>"><?= $fetch_products['category']; ?></option>
                  <option value="coffee">cafe</option>
                  <option value="fast food">acompañamientos</option>
