...
<body>
   ...
   <section class="accounts">
      ...
      <h1 class="heading">Gestión de Usuarios</h1>
            ...
            <tbody>
               ...
               ?>
                     <tr>
                        ...
                        <td><a href="users_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('¿eliminar esta cuenta?');"><button><i class="fa-solid fa-trash"></i></button></a></td>
                     </tr>
               <?php
                  }
               } else {
