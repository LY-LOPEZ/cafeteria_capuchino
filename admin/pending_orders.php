...
$current_page = 'pending_orders.php';
...
if ($order_search !== '') {
   $select_orders = $conn->prepare("SELECT * FROM `orders` WHERE payment_status = 'pending' AND id = ? ORDER BY id DESC");
...
<body>
   ...
   <section class="placed-orders orders-management">
      ...
      <h1 class="heading">pedidos pendientes</h1>

      <div class="table_header orders-toolbar">
         <p>Pedidos pendientes de verificacion</p>
      ...
      <div class="orders-table-wrapper">
         <table class="table">
            ...
            <tbody>
               ...
               <?php } else { ?>
                  <tr>
                     <td colspan="12" class="empty-table">No hay pedidos pendientes.</td>
                  </tr>
               <?php } ?>
            </tbody>
         </table>
