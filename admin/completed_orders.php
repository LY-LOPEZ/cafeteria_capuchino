...
$current_page = 'completed_orders.php';
...
if ($order_search !== '') {
   $select_orders = $conn->prepare("SELECT * FROM `orders` WHERE payment_status = 'completed' AND id = ? ORDER BY id DESC");
...
<body>
   ...
   <section class="placed-orders orders-management">
      ...
      <h1 class="heading">pedidos completados</h1>
      ...
      <div class="orders-table-wrapper">
         <table class="table">
            ...
            <tbody>
               ...
               <?php } else { ?>
                  <tr>
                     <td colspan="12" class="empty-table">No hay pedidos completados.</td>
                  </tr>
               <?php } ?>
            </tbody>
         </table>
